...
"$Id: xMCU2_withOffset.cc,v 1.1 2010-03-23 16:01:52 jschamba Exp $";
#endif /* lint */
...
unsigned int validl[] = {          0x000,       0x0200};  // this tells the lowest valid address
unsigned int validh[] = {          0x200,       0x8FFF};  // this tells the highest valid address
		 ...
		 )
{
  ...
  if (bytecount != 0) {
    ...
    unsigned int startAddr2 = startAddr + 0x6000;
