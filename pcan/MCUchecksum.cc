/* File name     : MCUchecksum.cc
 * Creation date : 4/30/2008
...
"$Id: MCUchecksum.cc,v 1.3 2011-10-31 14:42:03 jschamba Exp $";
#endif /* lint */
  ...
  while (hexfile.good()) {
    ...
    */
    ...
    cout << "length = " << setw(2) << dec << len 
	 ...
	 << " program (word aligned) address = " << address 
	 << endl;
#endif
