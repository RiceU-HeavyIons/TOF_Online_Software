...
"$Id: xMCU2_noIVT.cc,v 1.1 2010-03-23 16:01:17 jschamba Exp $";
#endif /* lint */
...
unsigned int validl[] = {          0x080,       0x4000};  // this tells the lowest valid address
unsigned int validh[] = {          0x100,       0x8FFF};  // this tells the highest valid address
