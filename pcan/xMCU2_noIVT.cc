...
"$Id: xMCU2_noIVT.cc,v 1.4 2011-10-31 14:59:27 jschamba Exp $";
#endif /* lint */
...
unsigned int validl[] = {          0x0,       0x4000};  // this tells the lowest valid address
unsigned int validh[] = {          0x0,       0x5FFF};  // this tells the highest valid address
/*
