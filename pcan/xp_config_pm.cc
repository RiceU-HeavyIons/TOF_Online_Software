...
"$Id: xp_config_pm.cc,v 1.1 2008-04-22 20:58:27 jschamba Exp $";
#endif /* lint */
...
#ifdef LOCAL_DEBUG
  printCANMsg(ms, "xp_config_pm: Sending CONFIGURE_TDC:Block Start command:");
#endif

  if ( sendCAN_and_Compare(ms, "xp_config_pm: CONFIGURE_TDC:Write Block Start", 4000000,2, true) != 0) // timeout = 4 sec
    my_private_exit(errno);
...
#ifdef LOCAL_DEBUG
    printCANMsg(ms, "xp_config_pm: Sending CONFIGURE_TDC:Block DATA packet:");
#endif
    
    
    if ( sendCAN_and_Compare(ms, "xp_config_pm: CONFIGURE_TDC:Block DATA", 4000000, 2, true) != 0) // timeout = 4 sec
      my_private_exit(errno);
...
#ifdef LOCAL_DEBUG
  printCANMsg(ms, "xp_config_pm: Sending CONFIGURE_TDC:Block DATA packet 12:");
#endif
  
  
  if ( sendCAN_and_Compare(ms, "xp_config_pm: CONFIGURE_TDC:Block DATA 12:", 4000000, 2, true) != 0) // timeout = 4 sec
    my_private_exit(errno);
...
#ifdef LOCAL_DEBUG
  printCANMsg(ms, "xp_config_pm: Sending CONFIGURE_TDC:Write Block End packet:");
#endif


  if ( sendCAN_and_Compare(ms, "xp_config_pm: CONFIGURE_TDC:Write Block End:", 4000000, 8, true) != 0) // timeout = 4 sec
    my_private_exit(errno);
...
#ifdef LOCAL_DEBUG
  printCANMsg(ms, "xp_config_pm: Sending CONFIGURE_TDC:Write Block Target Config PM packet:");
#endif
  
  if ( sendCAN_and_Compare(ms, "xp_config_pm: CONFIGURE_TDC:Write Block Target Config PM:", 4000000, 2, true) != 0) // timeout = 4 sec
    my_private_exit(errno);
