						...
						if(off && len) {
							...
							if((type != BTOW_ID) && (sec==0)) {
								...
								if(err_count < 100) {	// detailed log
									for(l=0;l<ETOW_MAXFEE;l++) {
										if(bad & (1<<l)) {
											LOG(CAUTION,"ETOW header corrupt (%u/%u) in crate %d: fiber token 0x%X: 0x%X 0x%X 0x%X 0x%X",
											    err_count,san.etow.evt_count,l+1,tlo,dta[l][0],dta[l][1],dta[l][2],dta[l][3]) ;
										}
										else {
											LOG(NOTE,"ETOW header OK (%u/%u) in crate %d: fiber token 0x%X: 0x%X 0x%X 0x%X 0x%X",
											    err_count,san.etow.evt_count,l+1,tlo,dta[l][0],dta[l][1],dta[l][2],dta[l][3]) ;
										}
									}
								}
								...
								if(err_count < 100) {	// detailed log
									for(l=0;l<ESMD_MAXFEE;l++) {
										if(bad & (1ll << l)) {
											LOG(CAUTION,"ESMD header corrupt (%u/%u) in crate %d: fiber token 0x%X: 0x%X 0x%X 0x%X 0x%X",
											    err_count,san.esmd.evt_count,l,tlo,dta[l][0],dta[l][1],dta[l][2],dta[l][3]) ;
										}
										else {
											LOG(NOTE,"ESMD header OK (%u/%u) in crate %d: fiber token 0x%X: 0x%X 0x%X 0x%X 0x%X",
											    err_count,san.esmd.evt_count,l,tlo,dta[l][0],dta[l][1],dta[l][2],dta[l][3]) ;
										}
									}
								}
								...
								if(err_count < 100) {	// detailed log
									for(l=0;l<BTOW_MAXFEE;l++) {
										if(bad & (1<<l)) {
											LOG(CAUTION,"BTOW header corrupt (%u/%u) in crate %d (%d): fiber token 0x%X: 0x%X 0x%X 0x%X 0x%X",
											    err_count,san.btow.evt_count,l+1,btow_fee_id[l],tlo,dta[l][0],dta[l][1],dta[l][2],dta[l][3]) ;
										}
										else {
											LOG(NOTE,"BTOW header OK (%u/%u) in crate %d (%d): fiber token 0x%X: 0x%X 0x%X 0x%X 0x%X",
											    err_count,san.btow.evt_count,l+1,btow_fee_id[l],tlo,dta[l][0],dta[l][1],dta[l][2],dta[l][3]) ;
										}
									}
								}
							...
							else if((type == BTOW_ID) && (sec == 1)) {	// BSMD
								LOG(DBG,"BSMD") ;
