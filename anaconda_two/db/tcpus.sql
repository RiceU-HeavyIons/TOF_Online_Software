...
-- west
insert into tcpus values (  1, 2, 43,  72,  68,  2, 'C2',  2,  0,  1,  1,  1);
insert into tcpus values (  2, 2, 44,  58,  58,  2, 'C3',  2,  1,  1,  2,  1);
insert into tcpus values (  3, 2, 45,  67,  63,  2, 'D0',  2,  2,  1,  3,  1);
insert into tcpus values (  4, 2, 46,   9,   6,  2, 'D1',  2,  3,  1,  4,  1);
insert into tcpus values (  5, 2, 47,  75,  71,  2, 'D2',  2,  4,  1,  5,  1);
insert into tcpus values (  6, 2, 48,  71,  67,  2, 'D3',  2,  5,  1,  6,  1);
insert into tcpus values (  7, 2, 49,  65,  61,  2, 'E0',  2,  6,  1,  7,  1);
insert into tcpus values (  8, 2, 50,  54,  50,  2, 'E1',  2,  7,  1,  8,  1);
insert into tcpus values (  9, 2, 51,  61,  57,  2, 'E2',  2,  8,  1,  9,  1);
insert into tcpus values ( 10, 2, 52,  64,  60,  2, 'E3',  2,  9,  1, 10,  1);
insert into tcpus values ( 11, 2, 53,  51,  47,  2, 'F0',  2, 10,  1, 11,  1);
insert into tcpus values ( 12, 2, 54,  50,  46,  2, 'F1',  2, 11,  1, 12,  1);
insert into tcpus values ( 13, 2, 55,  -1,  '',  2,  '',  -1,  0, -1,  0,  0);
insert into tcpus values ( 14, 2, 56,  -1,  '',  2,  '',  -1,  0, -1,  0,  0);
insert into tcpus values ( 15, 2, 57,  68,  64,  2,  'G0',  8,  2,  2,  3,  1);
insert into tcpus values ( 16, 2, 58,  76,  72,  2, 'G1',  8,  3,  2,  4,  1);
insert into tcpus values ( 17, 2, 59,  66,  62,  2, 'G2',  8,  4,  2,  5,  1);
insert into tcpus values ( 18, 2, 60,  46,  42,  2, 'G3',  8,  5,  2,  6,  1);
insert into tcpus values ( 19, 2, 61,  18,  14,  2, 'H0',  8,  6,  2,  7,  1);
insert into tcpus values ( 20, 2, 62,  14,  11,  2, 'H1',  8,  7,  2,  8,  1);
...
insert into tcpus values ( 51, 2, 33,  63,  59,  2, 'A0',  1,  2,  5,  3,  1);
insert into tcpus values ( 52, 2, 34,  70,  66,  2, 'A1',  1,  3,  5,  4,  1);
insert into tcpus values ( 53, 2, 35,  74,  70,  2, 'A2',  1,  4,  5,  5,  1);
insert into tcpus values ( 54, 2, 36,  42,  38,  2, 'A3',  1,  5,  5,  6,  1);
insert into tcpus values ( 55, 2, 37,  45,  41,  2, 'B0',  1,  6,  5,  7,  1);
insert into tcpus values ( 56, 2, 38,  49,  45,  2, 'B1',  1,  7,  5,  8,  1);
insert into tcpus values ( 57, 2, 39,  56,  52,  2, 'B2',  1,  8,  5,  9,  1);
insert into tcpus values ( 58, 2, 40,  58,  54,  2, 'B3',  1,  9,  5, 10,  1);
insert into tcpus values ( 59, 2, 41,  57,  53,  2, 'C0',  1, 10,  5, 11,  1);
insert into tcpus values ( 60, 2, 42,  59,  55,  2, 'C1',  1, 11,  5, 12,  1);
...
insert into tcpus values ( 66, 3, 33,  52,  48,  3, 'A0',  3,  5,  6,  6,  1);
insert into tcpus values ( 67, 3, 34,  69,  65,  3, 'A1',  3,  6,  6,  7,  1);
insert into tcpus values ( 68, 3, 35,  26,  22,  3, 'A2',  3,  7,  6,  8,  1);
insert into tcpus values ( 69, 3, 36,  44,  40,  3, 'A3',  3,  8,  6,  9,  1);
insert into tcpus values ( 70, 3, 37,  53,  49,  3, 'B0',  3,  9,  6, 10,  1);
insert into tcpus values ( 71, 3, 38,   8,   5,  3, 'B1',  3, 10,  6, 11,  1);
insert into tcpus values ( 72, 3, 39,   5,   2,  3, 'B2',  3, 11,  6, 12,  1);
insert into tcpus values ( 73, 3, 40,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 74, 3, 41,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 75, 3, 42,   4,   1,  3, 'C1',  4,  2,  7,  3,  1);
insert into tcpus values ( 76, 3, 43,   7,   4,  3, 'C2',  4,  3,  7,  4,  1);
insert into tcpus values ( 77, 3, 44,   6,   3,  3, 'C3',  4,  4,  7,  5,  1);
insert into tcpus values ( 78, 3, 45,  55,  51,  3, 'D0',  4,  5,  7,  6,  1);
insert into tcpus values ( 79, 3, 46,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 80, 3, 47,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 81, 3, 48,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 82, 3, 49,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 83, 3, 50,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 84, 3, 51,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 85, 3, 52,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 86, 3, 53,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 87, 3, 54,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 88, 3, 55,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 89, 3, 56,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 90, 3, 57,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 91, 3, 58,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 92, 3, 59,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 93, 3, 60,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 94, 3, 61,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
insert into tcpus values ( 95, 3, 62,  -1,  '',  3,   '', -1,  0, -1,  0,  0);
