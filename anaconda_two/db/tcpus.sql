...
insert into tcpus values ( 36, 1, 48,  12,   9,  1, 'D3',  9, 11,  3, 12,  0);
insert into tcpus values ( 37, 1, 49,  13,  10,  1, 'E0',  0,  0,  4,  1,  1);
insert into tcpus values ( 38, 1, 50,   6,  29,  1, 'E1',  0,  1,  4,  2,  0);
insert into tcpus values ( 39, 1, 51,  38,  34,  1, 'E2',  0,  2,  4,  3,  1);
insert into tcpus values ( 40, 1, 52,  16,  13,  1, 'E3',  0,  3,  4,  4,  1);
insert into tcpus values ( 41, 1, 53,  20,  16,  1, 'F0',  0,  4,  4,  5,  0);
...
insert into tcpus values ( 46, 1, 58,  82,  78,  1, 'G1',  0,  9,  4, 10,  1);
...
insert into tcpus values ( 80, 2, 47, 125, 122,  2, 'D2', 12,  7,  7,  8,  0);
...
insert into tcpus values (102, 4, 39,  69,  65,  4, 'B3',  5,  5,  9,  6,  0);
insert into tcpus values (103, 4, 40,  55,  51,  4, 'B2',  5,  6,  9,  7,  0);
