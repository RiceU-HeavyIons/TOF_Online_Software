...
**
** Created: Fri Nov 21 03:22:47 2008
...
static const char qt_meta_stringdata_Config[] = {
    "Config\0\0step(int)\0"
};

const QMetaObject Config::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Config,
...
int Config::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: step((*reinterpret_cast< int(*)>(_a[1]))); break;
        }
        _id -= 1;
    }
    return _id;
