...
insert into tcpus values (  9, 2, 41,   0,   0, 2, 'C0',  1,  3,  1,  1,  1);
insert into tcpus values ( 10, 2, 42, 196, 264, 2, 'C1',  2,  4,  1,  1,  1);
insert into tcpus values ( 11, 2, 43, 220, 288, 2, 'C2',  2,  6,  1,  1,  1);
insert into tcpus values ( 12, 2, 44, 224, 293, 2, 'C3',  2,  8,  1,  1,  1);
insert into tcpus values ( 13, 2, 45, 225, 294, 2, 'D0',  2, 10,  1,  1,  1);
insert into tcpus values ( 14, 2, 46, 226, 295, 2, 'D1',  1,  0,  1,  1,  1);
insert into tcpus values ( 15, 2, 47, 218, 289, 2, 'D2',  1,  2,  1,  1,  1);

-- South
insert into tcpus values ( 16, 1, 48, 233, 303, 1, 'A0',  1,  4,  1,  1,  1);
insert into tcpus values ( 17, 1, 49, 238, 306, 1, 'A1',  1,  6,  1,  1,  1);
insert into tcpus values ( 18, 1, 50, 247, 316, 1, 'A2',  1,  7,  1,  1,  1);
insert into tcpus values ( 19, 1, 51, 155, 220, 1, 'A3',  1,  8,  1,  1,  1);
insert into tcpus values ( 20, 1, 52, 231, 301, 1, 'B0',  1,  9,  1,  1,  1);
insert into tcpus values ( 21, 1, 53, 248, 317, 1, 'B1',  1, 10,  1,  1,  1);
insert into tcpus values ( 22, 1, 54, 181, 250, 1, 'B2',  1, 11,  1,  1,  1);
insert into tcpus values ( 23, 1, 55,   0,   0, 1, 'B3', -1,  0,  1,  1,  0);
insert into tcpus values ( 24, 1, 56, 229, 298, 1, 'C0', -1,  0,  1,  1,  1);
