...
insert into tcpus values (  7, 2, 39, 174, 245, 2, 'B2', 12,  0,  1,  1,  1);
insert into tcpus values (  8, 2, 40,   0,   0, 2, 'B3', -1,  0,  1,  1,  0);
insert into tcpus values (  9, 2, 41,   0,   0, 2, 'C0', -1,  0,  1,  1,  0);
insert into tcpus values ( 10, 2, 42, 196, 264, 2, 'C1', -1,  0,  1,  1,  1);
...
insert into tcpus values ( 22, 1, 54, 181, 250, 1, 'B2', -1,  0,  1,  1,  1);
