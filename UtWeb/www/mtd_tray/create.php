...
Session::check_login("../mtd_tray/create.php");
...
tsw_header("MTD Tray Creation Page");
tsw_toolbar();
?>
<div id="main">
<div class='title'>MTD Tray Creation</div>
<?php
  ...
  echo "<input name='start_date' type='text' value='YYYY-MM-DD' size='12'/></td>";
  echo "<td>Serial Number<br>";
  echo "<input name='serial' type='text' size='11'/></td></tr>";
