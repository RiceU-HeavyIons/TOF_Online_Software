...
Session::update_ref("../tray/notes.php?id=$id");

function newtext($id){
  echo "<form name='insert' action='update_tray_notes.php' method='post'/>\n";
...
<?php
if(Session::loggedin()) {
   echo "<form action='update_tray_notes.php' method='post'>";
