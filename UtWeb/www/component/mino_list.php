...
tsw_header('MINO Component List');
...
echo "<div id='main'>\n";
echo "<div class='title'>MINO Component List</a></div>\n";
...
echo "  <th>note</th>\n";
echo " </tr>\n";
$tot = Component::count("component_type_id=7");
$lim = 20;
$off = 0;
...
$off = $lim*($page - 1);
if($tot > $lim) { pagenate("mino_list.php", $page, $tot, $lim, ""); }

$ln = 0;
foreach(Component::find_all("component_type_id=7","cast(serial as signed) desc", "$off, $lim", "") as $c) {
  $ll = $ln % 2;
