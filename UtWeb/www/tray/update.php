...
Session::check_login("../tray/inner.php?id=$tray_id");
...
#    $insert = mysql_query("update trays set status='shipped' where id='$tray_id'", $con) or die (mysql_error());
  ...
  if ($type == 'new_tray') {
    ...
    $result1 = mysql_query("select count(*) as count from trays where sn < 200", $con);
  ...
  if ($type == 'modify_tcpu'){
    $tcpu=trim($tcpu, "*");
    if($tcpu=='Remove'){$edit = mysql_query("update components set tray_id=default, slot=default where component_type_id='1' and tray_id=$tray_id", $con) or die(mysql_error());}
    elseif($tcpu=='----------' || $tcpu=='Pick one'){header( "Location: ./edit.php?id=$tray_id");}
    else{
      ...
      $update = mysql_query("update components set tray_id=$tray_id, slot='1' where serial='$tcpu' and component_type_id='1'", $con) or die(mysql_error());
    }
  ...
  if ($type == 'modify_ttrig'){
    $ttrig=trim($ttrig, "*");
    if($ttrig=='Remove'){$edit = mysql_query("update components set tray_id=default, slot=default where component_type_id='5' and tray_id=$tray_id", $con) or die(mysql_error());}
    elseif($tcpu=='----------' || $tcpu=='Pick one'){header( "Location: ./edit.php?id=$tray_id");}
    else{
      ...
      $update = mysql_query("update components set tray_id=$tray_id, slot='1' where serial='$ttrig' and component_type_id='5'", $con) or die(mysql_error());
    }
    header( "Location: ./edit.php?id=$tray_id");
  }
  ...
  if ($type == 'modify_tdig'){
    $tdig=trim($tdig, "*");
    if($tdig=='Remove'){$edit = mysql_query("update components set tray_id=default, slot=default where component_type_id='2' and tray_id=$tray_id and slot=$slot", $con) or die(mysql_error());}
    elseif($tdig=='----------' || $tdig=='Pick one'){header( "Location: ./edit.php?id=$tray_id");}
    else{
      $edit = mysql_query("update components set tray_id=default, slot=default where component_type_id='2' and tray_id=$tray_id and slot=$slot", $con) or die(mysql_error());
      $update = mysql_query("update components set tray_id=$tray_id, slot=$slot where serial='$tdig' and component_type_id='2'", $con) or die(mysql_error());
    }
    header( "Location: ./edit.php?id=$tray_id");
  }
  ...
  if ($type == 'modify_tino'){
    $tino=trim($tino, "*");
    if($tino=='Remove'){$edit = mysql_query("update components set tray_id=default, slot=default where component_type_id='3' and tray_id=$tray_id and slot=$slot", $con) or die(mysql_error());}
    elseif($tino=='----------' || $tino=='Pick one'){header( "Location: ./edit.php?id=$tray_id");}
    else{
      $edit = mysql_query("update components set tray_id=default, slot=default where component_type_id='3' and tray_id=$tray_id and slot=$slot", $con) or die(mysql_error());
      $update = mysql_query("update components set tray_id=$tray_id, slot=$slot where serial='$tino' and component_type_id='3'", $con) or die(mysql_error());
    }
    header( "Location: ./edit.php?id=$tray_id");
  }
  ...
  if ($type == 'modify_module'){
    $module=trim($module, "*");
    if($module=='Remove'){$edit = mysql_query("update modules set tray_id=default, slot=default where tray_id=$tray_id and slot=$slot", $con) or die(mysql_error());}
    elseif($module=='----------' || $module=='Pick one'){header( "Location: ./edit.php?id=$tray_id");}
    else{
      $edit = mysql_query("update modules set tray_id=default, slot=default where tray_id=$tray_id and slot=$slot", $con) or die(mysql_error());
      $update = mysql_query("update modules set tray_id=$tray_id, slot=$slot where serial='$module'", $con) or die(mysql_error());
    }
    header( "Location: ./edit.php?id=$tray_id");
  }
?>
