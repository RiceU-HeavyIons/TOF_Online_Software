...
"$Id: MCU2.cc 756 2012-07-05 20:44:12Z jschamba $";
#endif /* lint */
...
#ifndef NO_CAN
    if ( sendCAN_and_Compare(h, ms, "MCU2:BlockStart", 4000000, 2, true) != 0) { // timeout = 4 sec
...
#ifndef NO_CAN
      if ( sendCAN_and_Compare(h, ms, "MCU2:BlockData", 4000000, 2, true) != 0) { // timeout = 4 sec
	my_private_exit(errno);
      }
#endif
...
#endif
#ifndef NO_CAN
    if ( sendCAN_and_Compare(h, ms, "MCU2:BlockTargetMCU2", 4000000, 2, true) != 0) { // timeout = 4 sec
